/* globals Image: false, FileReader: false */
...
const ERR_FILE_TOO_SMALL = `Your image is not large enough. Images need a minumum width of ${config.api.minImageDimensions}px`
