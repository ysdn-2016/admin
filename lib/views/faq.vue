...
<template>
	<div class="faq">
		...
		<div id="whats-the-difference-between-project-types" class="question">
			...
			<p>In standard projects, images will automatically show up on the site. In case studies, you'll need to add them to your project description for them to appear.</p>
